...
const questions = async () => {
    ...
    if (answer.role === "Manager") {
        ...
        newStaffData.push(new Manager(answer.name, answer.id, answer.email, officeNumber.officeNumber));
        ...
        newStaffData.push(new Engineer(answer.name, answer.id, answer.email, github.github));
